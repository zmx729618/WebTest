...
public class BlockingQueueTest { /** 定义一个盘子类，可以放鸡蛋和取鸡蛋 */
	...
	static class AddThread extends Thread {
		private BlockingQueueTest plate;
		private Object egg = new Object();

		public AddThread(BlockingQueueTest plate) {
			this.plate = plate;
		}
	...
	static class GetThread extends Thread {
		...
		public GetThread(BlockingQueueTest plate) {
			this.plate = plate;
		}
	...
	public static void main(String[] args) {
		BlockingQueueTest plate = new BlockingQueueTest();
		// 先启动10个放鸡蛋线程
		for(int i = 0; i < 10; i++) {
