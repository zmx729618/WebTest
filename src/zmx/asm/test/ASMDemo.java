...
public final class ASMDemo {
    ...
    public static void main(String[] args) throws SecurityException,
        ...
        String[] s = getMethodParamNames(ASMDemo.class.getMethod("getMethodParamNames", Method.class));
        System.out.println(Arrays.toString(s));

        s = getMethodParamNames(ASMDemo.class.getDeclaredMethod("sameType",Type[].class, Class[].class));
        System.out.println(Arrays.toString(s));
