...
public class TimingWheel<E> {
	...
	private final int ticksPerWheel; //每个轮子的“齿轮”数
	
	private final long tickDuration; //停顿时间
	
	private volatile int currentTickIndex = 0; //当前停顿位移数默认为0
	...
	private final AtomicBoolean shutdown = new AtomicBoolean(); //原子操作
	
	private final ReadWriteLock lock = new ReentrantReadWriteLock(); //可重入读写锁
