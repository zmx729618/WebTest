...
//        SortedSetOperate();
//        HashOperate(); 
        jedisPool.returnResource(jedis); //连接返回到池中
        shardedJedisPool.returnResource(shardedJedis); //连接返回到池中
    }
	...
	private void ListOperate() {
        ...
        System.out.println("所有元素-stringlists："+shardedJedis.lrange("stringlists", 0, shardedJedis.llen("stringlists")));
        ...
        System.out.println("子串-第1个开始到结束："+shardedJedis.lrange("stringlists", 0, -1));
	...
	private void KeyOperate() {
        ...
        System.out.println("新增key999,value999键值对："+jedis.set("key999", "value999"));
        System.out.println("key999的值"+jedis.get("key999"));
        // 判断key否存在 
        ...
        System.out.println("key002的值："+jedis.get("key002"));
        // 设置 key001的过期时间
